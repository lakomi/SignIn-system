package com.example.SignInsystem.config;

import com.example.SignInsystem.filter.JWTAuthenticationFilter;
import com.example.SignInsystem.filter.JWTLoginFilter;
import com.example.SignInsystem.service.impl.MyUserDetailServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()           //关闭csrf
                ...
                .antMatchers("/user/loginU","/user/loginA","/user/modifyPw","/user/test","/info/*","/admin/*").permitAll()
